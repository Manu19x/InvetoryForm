    ...
    public partial class ProductForm : Form
    {
        ...
        private void button_update_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    string updateQuery = "UPDATE Product SET name_prod='" + TextBox_name.Text + "',price_prod=" + TextBox_price.Text + ",qty_prod=" + TextBox_qty.Text + ",categ_prod='" + comboBox_category.Text + "'";
        ...
        private void button_delete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    string deleteQuery = "DELETE FROM Product WHERE Id_prod=" + TextBox_id.Text + "";
        ...
        {
            string selectQuerry = "SELECT *FROM Product WHERE categ_prod='"+comboBox_search.SelectedValue.ToString()+"'";
            SqlCommand command = new SqlCommand(selectQuerry, dBCon.GetCon());
            SqlDataAdapter adapter = new SqlDataAdapter(command);
            DataTable table = new DataTable();
            adapter.Fill(table);
